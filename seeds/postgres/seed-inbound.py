...
stock_inbound_item tables directly to the database. Connection is configured via
...
def main():
    ...
    parser.add_argument('--samples',    type=int, default=None, help='Number of inbound transactions (default: 100, or auto if --daily-min)')
